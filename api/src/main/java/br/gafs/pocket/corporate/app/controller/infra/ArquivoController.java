...
import br.gafs.pocket.corporate.app.controller.*;
...
public class ArquivoController {
    ...
    public Response uploadFile(
        ...
        return Response.status(Status.OK).entity(adminService.upload(fileDetail.getFileName(), read(uploadedInputStream))).build();
    }
    ...
    public Response downloadFile(@PathParam("arquivo") Long identificador) throws IOException {
        Arquivo arquivo = adminService.buscaArquivo(identificador);
