...
public class AutenticacaoFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        resp.addHeader("Access-Control-Allow-Headers", "empresa, dispositivo, authorization, set-authorization, " + req.getHeader("Access-Control-Request-Headers"));
        resp.addHeader("Access-Control-Expose-Headers", "empresa, dispositivo, authorization, set-authorization, force-register, force-reset");
