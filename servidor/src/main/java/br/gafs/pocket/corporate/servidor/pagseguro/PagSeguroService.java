package br.gafs.pocket.corporate.servidor.pagseguro;
...
public class PagSeguroService {
    ...
    public StatusPagamento getStatusPagamento(String referencia, ConfiguracaoEmpresaDTO configuracao) {
        try {
    ...
    public String buscaReferenciaPorCodigo(String codigo, ConfiguracaoEmpresaDTO credenciais) {
        try {
    ...
    public String buscaReferenciaIdTransacao(String idTransacao, ConfiguracaoEmpresaDTO credenciais) {
        try {
    ...
    public String realizaCheckout(Pedido pedido, ConfiguracaoEmpresaDTO credenciais){
    ...
    private Credentials getCredentialsPagSeguro(ConfiguracaoEmpresaDTO configuracao) throws PagSeguroServiceException {
