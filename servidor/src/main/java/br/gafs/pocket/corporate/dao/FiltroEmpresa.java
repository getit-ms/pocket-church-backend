 ...
 * @author Gabriel
 */
public class FiltroEmpresa extends AbstractQuery implements Queries.PaginatedCustomQuery {

    public FiltroEmpresa(FiltroEmpresaDTO filtro) {
        StringBuilder query = new StringBuilder("from Empresa i where 1=1 ");
