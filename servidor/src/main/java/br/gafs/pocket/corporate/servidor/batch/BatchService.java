package br.gafs.pocket.corporate.servidor.batch;
...
import br.gafs.pocket.corporate.servidor.batch.dto.AgenteDTO;
import br.gafs.pocket.corporate.servidor.batch.dto.ExecucaoServicoDTO;
import br.gafs.pocket.corporate.servidor.batch.dto.LoginDTO;
import br.gafs.pocket.corporate.servidor.rest.EasyRESTClient;
import br.gafs.pocket.corporate.servidor.rest.EasyRESTResponse;
...
public class BatchService {
    ...
    @Asynchronous
    public void processaBoletim(String empresa, Long boletim) {

        executeService("processa-boletim", "Processamento de Boletim " + empresa + " " + boletim,
                entradas().set("EMPRESA", empresa).set("BOLETIM", boletim.toString()));
    ...
    @Asynchronous
    public void processaCifra(String empresa, Long cifra) {

        executeService("processa-cifra", "Processamento de Cifra " + empresa + " " + cifra,
                entradas().set("EMPRESA", empresa).set("CIFRA", cifra.toString()));

    }

    @Asynchronous
    public void processaEstudo(String empresa, Long estudo) {

        executeService("processa-estudo", "Processamento de Estudo " + empresa + " " + estudo,
                entradas().set("EMPRESA", empresa).set("ESTUDO", estudo.toString()));
