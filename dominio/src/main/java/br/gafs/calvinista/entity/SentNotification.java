...
@NamedNativeQueries({
    ...
    @NamedNativeQuery(name = "SentNotification.removeNotificacao", query = "delete from tb_sent_notification sn where sn.id_notificacao_schedule = #notificacao and sn.chave_igreja = #igreja and ((sn.chave_dispositivo = #dispositivo and sn.id_membro is null) or sn.id_membro = #membro)")
})
@NamedQueries({
