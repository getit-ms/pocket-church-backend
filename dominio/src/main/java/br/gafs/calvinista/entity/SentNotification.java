...
@NamedQueries({
    ...
    @NamedQuery(name = "SentNotification.findNaoLidasDispositivo", query = "select sn from SentNotification sn where sn.dispositivo.chave = :dispositivo and sn.membro.id is null"),
