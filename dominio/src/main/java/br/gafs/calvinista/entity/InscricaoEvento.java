...
@NamedQueries({
    ...
    @NamedQuery(name = "InscricaoEvento.findAtivosByIgreja", query = "select ie from InscricaoEvento ie where ie.chaveIgreja = :chaveIgreja and ie.evento.dataHoraTermino >= CURRENT_TIMESTAMP order by ie.data")
})
